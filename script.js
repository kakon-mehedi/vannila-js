...
if (REPORT_INFO.regions) {
	regions = generateElement('p', REPORT_INFO.regions);
...
if (REPORT_INFO.departments) {
	departments = generateElement('p', REPORT_INFO.departments);
...
if (REPORT_INFO.partners) {
	partners = generateElement('p', REPORT_INFO.partners);
...
if (REPORT_INFO.products) {
	products = generateElement('p', REPORT_INFO.products);
